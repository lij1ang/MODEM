...
from models import LR, WDL, DSSM, FM, DeepFM, YouTubeDNN, FFM, PNN, DCN, DIN, UBR, COSMO, DIEN, GRU4REC,BST,DIN_SESSION,MISS,COSMO2,NCF,Pinet,ISN,DIN_BPR,MODEM,MODEM2
...
def get_model(model_name, model_config, data_config):
    ...
    if model_name == 'lr':
        ...
        return MODEM(model_config,data_config)
    elif model_name == 'modem2':
        return MODEM2(model_config,data_config)
    else:
